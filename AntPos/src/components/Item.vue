<template>
    <div>
        <div :class="['flex w-full py-2 px-3 justify-between hover:cursor-pointer text-center' ,items.custom_open ? 'rounded-t-2xl' : 'rounded']" style="background-color: #f8f8fc !important; color: #82868f !important; font-family: 'futura-pt', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif !important; font-size: 17px !important;">
            <div class="flex items-center h-[100%] rounded" @click="items.custom_open = !items.custom_open" style="background-color: #7c8bca !important;">
        ...
        <div v-if="items.custom_open" class="flex flex-col w-full py-1 px-3 rounded-b-2xl justify-between" style="background-color: #ffffff !important; color: #82868f !important; font-family: 'futura-pt', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif !important; font-size: 17px !important;">
